    ...
    public class FeedBackController : Controller
    {
        ...
        public async Task<IActionResult> Edit(MainViewModel inputMainViewModel)
        {
            ...
            foreach (var feedback in inputMainViewModel.Feedback)
            {
                ...
                if (feedBackResult.Answer != inputFeedBack.Answer)
                {
                    feedBackResult.Answer = inputFeedBack.Answer;
                    feedBackResult.Notes = inputFeedBack.Notes;
                    feedBackResult.ResponseDate = DateTime.Now;
                }
            ...
            //else
            //{
            //    return BadRequest("Please verify the Feedback Details.");
            //}
        }
